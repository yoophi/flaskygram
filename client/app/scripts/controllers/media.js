...
//   .controller('MediaCtrl', ['$scope', '$log', function ($scope, $log) {
//     $log.debug('MediaCtrl');
//   }]);
...
app.controller('MediaCtrl', ['$scope', '$http', '$timeout', '$compile', 'Upload', function ($scope, $http, $timeout, $compile, Upload) {
